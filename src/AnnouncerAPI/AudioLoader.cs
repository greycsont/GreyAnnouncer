...
public class AudioLoader : IAudioLoader
{
    ...
    private IAnnouncerPathProvider _pathProvider;
    public string announcerPath => _pathProvider?.announcerPath;
    ...
    public void UpdateSetting(AnnouncerConfig newAnnouncerConfig)
    {
